 ...
 *
 * Renders the HTML <head> section and site navigation bar for every
 * public-facing Download Manager page.
 *
 * Expects the consuming page to set:
...
<header class="site-header">
    <div class="container header-inner">
        ...
        <nav class="primary-nav" aria-label="Primary navigation">
            <ul>
                <li><a href="<?= SITE_URL ?>">All Files</a></li>
                <?php
                $navCategories = getCategories();
                foreach ($navCategories as $cat):
                ?>
                    <li>
                        <a href="<?= SITE_URL ?>?category=<?= urlencode($cat) ?>">
                            <?= e($cat) ?>
                        </a>
                    </li>
                <?php endforeach; ?>
                <?php if (!empty($_SESSION['admin_id'])): ?>
                    <li><a href="<?= SITE_URL ?>/admin/" class="btn btn--primary btn--sm">Admin</a></li>
                <?php endif; ?>
            </ul>

            <form class="header-search" action="<?= SITE_URL ?>" method="get" role="search">
                <label for="header-search-input" class="sr-only">Search files</label>
                <input
